# Validation: 4 rows, usual compiler settings without an unroll pragma
...
| --- | ---: | ---: |
| Total ticks | 3845 | 3844 |
| Summed VF duration (us) | 0.331 | 0.331 |
| Vector loads | 64 | 64 |
| Vector stores | 64 | 64 |
| Vector-loop setup instructions | 1 | 1 |

Original baseline: 3866 saved ticks. All instruction-name/count
...
All 4096 normalized outputs and row sums passed the same NumPy checker:
...
Summed input/output DMA: 0.541/0.460 us.
Model wall time: 25.5798 s, including contention from parallel runs.
...
Artifact directory: `build/sim-ZRwD5uIv/`, containing tensors,
