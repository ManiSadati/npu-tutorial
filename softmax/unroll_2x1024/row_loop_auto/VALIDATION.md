# Validation: 2 rows, usual compiler settings without an unroll pragma
...
| --- | ---: | ---: |
| Total ticks | 3054 | 3059 |
| Summed VF duration (us) | 0.198 | 0.198 |
| Vector loads | 32 | 32 |
| Vector stores | 32 | 32 |
| Vector-loop setup instructions | 1 | 1 |

Original baseline: 3012 saved ticks. All instruction-name/count
...
All 2048 normalized outputs and row sums passed the same NumPy checker:
...
Summed input/output DMA: 0.380/0.322 us.
Model wall time: 18.4792 s, including contention from parallel runs.
...
Artifact directory: `build/sim-8ghiPjPo/`, containing tensors,
