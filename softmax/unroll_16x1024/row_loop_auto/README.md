# 16x1024 softmax: compiler-selected row-loop optimization
...
One vector block computes the full normalized 16x1024 output. DMA geometry,
...
```bash
cd ~/npu-tutorial/softmax/unroll_16x1024/row_loop_auto
bash run.sh
