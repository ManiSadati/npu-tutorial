# Validation: 20 rows, usual compiler settings without an unroll pragma
...
| --- | ---: | ---: |
| Total ticks | 10100 | 10090 |
| Summed VF duration (us) | 1.392 | 1.392 |
| Vector loads | 320 | 320 |
| Vector stores | 320 | 320 |
| Vector-loop setup instructions | 1 | 1 |

Original baseline: 10584 saved ticks. All instruction-name/count
...
All 20480 normalized outputs and row sums passed the same NumPy checker:
...
Summed input/output DMA: 1.749/1.669 us.
Model wall time: 71.2995 s, including contention from parallel runs.
...
Artifact directory: `build/sim-0QZjEo9B/`, containing tensors,
